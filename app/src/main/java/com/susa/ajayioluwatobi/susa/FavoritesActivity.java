...
public class FavoriteActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Favorite,UserPostHolder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Favorite, UserPostHolder>
                (Favorite.class,R.layout.post_row,UserPostHolder.class, db2) {
            @Override
            protected void populateViewHolder(UserPostHolder viewHolder, Favorite model, int position) {
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                break;
            case 2:
				Intent mIntent = new Intent(FavoritesActivity.this, FeedActivity.class);
            ...
            case 3:
                break;
			case 4:
               // Intent nIntent = new Intent(FavoritesActivity.this, NotificationsActivity.class);

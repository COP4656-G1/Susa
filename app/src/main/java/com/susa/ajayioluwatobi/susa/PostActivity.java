...
public class PostActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    //implement to store Tab Names - WJL
    ...
    private String city;
    private ImageView image_1,post, feed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post= (ImageView) findViewById(R.id.Post_Button);
        feed= (ImageView) findViewById(R.id.feed_button);
            ...
            public void onClick(View v) {
                ...
                if(location_assert && FormComplete() ) {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(coordinatorLayout, "Posted", Snackbar.LENGTH_LONG);
    ...
    private void postLease(){
        ...
        timeOf = date.toString();
            ...
            UserPost userPost = new UserPost(value, addy, city, des, Uid, timeOf, temp_image, temp_image2, temp_image3,useremail);
